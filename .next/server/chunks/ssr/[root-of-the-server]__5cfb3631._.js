...
{
// src/app/actions.ts
/* __next_internal_action_entry_do_not_use__ [{"4056f992617fbe68b9067f948b5de918dd7188d3cc":"checkDistractionAction","4074340c73375fb6809e8b2add8de389ae6f983d05":"generateFocusQuestionAction","40fe6b84f52c42f71f2f2833eb70af2a9a93fb175a":"extractWebsitesAction"},"",""] */ __turbopack_context__.s({
...
async function extractWebsitesAction(input) {
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$extract$2d$websites$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["extractWebsites"])(input);
...
async function generateFocusQuestionAction(input) {
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$generate$2d$focus$2d$question$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["generateFocusQuestion"])(input);
        return result;
    } catch (error) {
...
;
async function Home() {
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createServerComponentClient"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5cfb3631._.js.map